...
urlpatterns = [
    ...
    path('references/caja-conceptos', views.references_caja_conceptos, name='alegra-references-caja-conceptos'),
    ...
    path('references/receipt-formas-pago', views.references_receipt_formas_pago, name='alegra-references-receipt-formas-pago'),
    path('references/save-receipt-formas-pago', views.references_save_receipt_formas_pago, name='alegra-references-save-receipt-formas-pago'),
    ...
    path('batches/<int:batch_id>/caja-journal-bills', views.batch_caja_journal_bills, name='alegra-batch-caja-journal-bills'),
    path('batches/<int:batch_id>/caja-journal-build', views.batch_caja_journal_build, name='alegra-batch-caja-journal-build'),
